...
nice --2 mplayer2 -cache 8192 -framedrop -autosync 30 -quiet -aid 3 -fps 23.976 -demuxer lavf -lavfdopts format=mpeg -vc ffvc1  $1

#mplayer -vo gl2 -ao alsa:device=iec958 -fps 30000/1001 -demuxer lavf -aid 5 $1
...
#mplayer -fs -ao alsa -vsync -vo vdpau -vc ffmpeg12vdpau,ffh264vdpau,ffwmv3vdpau,ffvc1vdpau $1

#mplayer -fs -ao alsa -vsync -vo vdpau -vc ffmpeg12vdpau,ffh264vdpau,ffwmv3vdpau,ffvc1vdpau -lavdopts skiploopfilter=nonref $1
